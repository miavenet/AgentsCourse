...
Source: <https://codelabs.developers.google.com/developer-knowledge-mcp-antigravity>

## 1. Introduction

**Note:** Are you still using the Gemini CLI? This guide covers the Antigravity CLI. More information on how to transition can be found in [this official blog post](//developers.googleblog.com/an-important-update-transitioning-gemini-cli-to-antigravity-cli/).

[**Google Developer Knowledge**](//developers.google.com/knowledge) is the canonical, machine-readable source of Google's public developer documentation. It's programmatically accessible via Application Programming Interface (API) and Model Context Protocol (MCP) so that developers can integrate it into applications and workflows.
...
- Antigravity 2.0, IDE, and/or CLI installed on your local machine. You can find more detail and installation guidance from [the official website](//antigravity.google/docs/home).

## Explore more MCPs and tools

In this codelab we only cover a few basic examples of what can be done using the Google Developer Knowledge MCP server. To see the full list of Google MCP servers and tools available, refer to the [Supported Products](//docs.cloud.google.com/mcp/supported-products).
...
Now let's configure Antigravity to use the MCP endpoint. If you don't have Antigravity 2.0, IDE, and/or CLI installed, follow the instructions on the [Antigravity website](//antigravity.google/docs/home).
