...
![Figure 1](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-1.png)
...
![Figure 2](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-2.png)
...
| Dimension | Vibe Coding | Structured AI-Assisted  | Agentic     |
| --------- | ----------- | ----------------------- | ----------- |
|           |             | Coding                  | Engineering |
Intent specification Casual natural  Detailed prompts  Formal specs,
|              | language prompts | with examples          | architecture docs,    |
| ------------ | ---------------- | ---------------------- | --------------------- |
|              |                  | and constraints        | memory files          |
| Verification | "Does it seem    | Manual                 | Automated test        |
|              | to work?"        | testing, spot-checking | suites, CI/CD gates,  |
LM judges
|     | Minimal; developer  | Selective review of  | Comprehensive  |
| --- | ------------------- | -------------------- | -------------- |
Codebase
understanding may not read the  critical paths review of architecture;
|     | generated code |     | AI handles  |
| --- | -------------- | --- | ----------- |
implementation details
Error handling Copy-paste error  Developer diagnoses  Agents self-diagnose
|     | messages back to  | root cause, AI  | within defined bounds;  |
| --- | ----------------- | --------------- | ----------------------- |
|     | the AI            | implements fix  | humans handle           |
architectural issues
Appropriate scope Prototypes,  Features within  Production systems,
|     | scripts, personal     | established codebases | team-scale       |
| --- | --------------------- | --------------------- | ---------------- |
|     | projects, hackathons  |                       | development      |
|     | High; acceptable for  | Moderate; human       | Low; systematic  |
Risk profile
|     | disposable code | judgment at     | verification at  |
| --- | --------------- | --------------- | ---------------- |
|     |                 | key checkpoints | every stage      |
![Table 1](assets/whitepaper-the-new-sdlc-with-vibe-coding/table-1.png)

*Table 1: The Spectrum from Vibe Coding to Agentic Engineering*

![Figure 3](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-3.png)
...
![Figure 4](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-4.png)
...
![Figure 5](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-5.png)
...
![Figure 6](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-6.png)
...
![Figure 7](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-7.png)
...
![Figure 8](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-8.png)
...
![Figure 9](assets/whitepaper-the-new-sdlc-with-vibe-coding/figure-9.png)
